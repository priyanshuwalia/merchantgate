...
CREATE INDEX IF NOT EXISTS "idx_campaigns_merchant" ON "campaigns" ("merchant_id");--> statement-breakpoint
...
ALTER TABLE "campaigns" ADD CONSTRAINT IF NOT EXISTS "campaigns_merchant_id_merchants_id_fkey" FOREIGN KEY ("merchant_id") REFERENCES "merchants"("id") ON DELETE CASCADE;